...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.canvas = Canvas(width=300, height=250, bg=BG)
        self.question_text=self.canvas.create_text(150, 125, width= 280,text="Some Question Text", font=FONT,fill=THEME_COLOR)
        self.canvas.grid(row=1, column=0, columnspan=2, pady=50)

        right_img = PhotoImage(file="images/true.png")
        false_img = PhotoImage(file="images/false.png")
        self.x_button = Button(image=false_img, highlightthickness=0, command=self.false_pressed)
